...
if (!existsSync(PAGES)) {
  console.error(`no PBIR report at ${join(ROOT, project.reportDir)}`);
  console.error('harness.mjs writes a page into a report; it needs one. Check `reportDir` in project.config.mjs.');
  process.exit(1);
}
